                          ...
                          >
                            ...
                            <ArrowRight
                              className={`ml-2 w-4 h-4 transition-transform ${
                                hoveredItemId === item.id ? "translate-x-1" : ""
                              }`}
                            />
                          </a>
                        ) : (
                          <span className="text-gray-600 cursor-not-allowed text-sm inline-flex items-center">
                            Más información
                            <ArrowRight className="ml-2 w-4 h-4 opacity-40" />
                          </span>
                        )}
                        <span
